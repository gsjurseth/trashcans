...
app.get("/trashcans", jsonParser, (req, res) => {
...
app.get("/trashcans/:tname", jsonParser, (req, res) => {
...
app.delete("/trashcans/:tname", jsonParser, (req, res) => {
...
app.post("/trashcans", jsonParser, (req, res) => {
